...
import net.straws11.egyptianpast.item.ModArmorMaterials;
...
public class ModEquipmentAssetProvider implements DataProvider {
    ...
    private static void bootstrap(BiConsumer<ResourceKey<EquipmentAsset>, EquipmentClientInfo> output) {
        output.accept(ModArmorMaterials.PHARAOH_ARMOR_KEY, EquipmentClientInfo.builder()
                .addHumanoidLayers(Identifier.fromNamespaceAndPath(EgyptianPast.MOD_ID, "pharaoh_armor"), false)
                .build()
        );
    }
    ...
    public String getName() {
        return "Egyptian Past Equipment Definitions";
    }
}
